...
switch (_filter) do
{
	...
	case 0:
	{
		...
		["U_C_Journalist","Journalist clothes",1500],
		["U_C_Scientist","Scientist clothes",2500],
		["U_NikosBody","Jeans & shirt",2500],
		["U_C_Soldier_VR","VR Entity Suit",50000],
		["U_I_Soldier_VR","VR Entity Suit",50000],
		["U_B_Soldier_VR","VR Entity Suit",50000],
		["U_O_Soldier_VR","VR Entity Suit",50000],
		["U_C_PriestBody","Clerical Robes",2500],
	...
	case 1:
	{
		[
			...
			["H_TurbanO_blk",nil,225],
			["H_ShemagOpen_tan",nil,250],
			["H_BandMask_blk","Hat & Bandanna",300],
			["H_Booniehat_tan",nil,425],
			["H_HelmetLeaderO_ocamo",nil,500],
			["H_HelmetSpecB_blk",nil,500],
			["H_Watchcap_blk",nil,300],
			["H_Hat_blue",nil,310],
			["H_Hat_brown",nil,276],
	...
	{
		[
			["V_Rangemaster_belt","Rangemaster Belt",5000],
			["V_Press_F","Vest (Press)",15000]
		];
	};
