...
[
	"Welcome to the Fractal Gaming Altis Life server! A few things have changed with Altis Life RPG that you need to be aware of!",
	...
	"Teamspeak Address:  tseu5.vilayer.com:10006"
	"READ THE MAP TABS!"
];
