...
//[shortVar,reward]
life_illegal_items = [["heroinu",3000],["heroinp",6000],["cocaine",3500],["cocainep",7000],["marijuana",3000],["turtle",8000],["blastingcharge",10000],["boltcutter",10000]];
...
_CONST__(life_garage_sell,life_garage_sell);